...
This QP is unsolvable since \gi{Uother} in turn depends on its solution.
To break this circular dependency, the problem is initially solved with an estimate for \gi{Uother} obtained from the previous QP solution.
